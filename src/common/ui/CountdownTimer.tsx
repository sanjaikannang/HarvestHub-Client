...
// Presentational countdown pill — callers own the ticking (setInterval) and
// just pass the current remaining milliseconds in. Useful for anything with
// a deadline (e.g. a bidding session's time remaining). Urgency escalates
